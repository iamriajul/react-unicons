...
// src/icons/uil-images.tsx
var uil_images_exports = {};
__export(uil_images_exports, {
  default: () => uil_images_default
});
module.exports = __toCommonJS(uil_images_exports);
...
var uil_images_default = UilImages;
