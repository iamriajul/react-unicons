...
// src/icons/uil-hunting.tsx
var uil_hunting_exports = {};
__export(uil_hunting_exports, {
  default: () => uil_hunting_default
});
module.exports = __toCommonJS(uil_hunting_exports);
...
var uil_hunting_default = UilHunting;
