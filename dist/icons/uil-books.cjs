...
// src/icons/uil-books.tsx
var uil_books_exports = {};
__export(uil_books_exports, {
  default: () => uil_books_default
});
module.exports = __toCommonJS(uil_books_exports);
...
var uil_books_default = UilBooks;
