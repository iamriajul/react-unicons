...
// src/icons/uil-squint.tsx
var uil_squint_exports = {};
__export(uil_squint_exports, {
  default: () => uil_squint_default
});
module.exports = __toCommonJS(uil_squint_exports);
...
var uil_squint_default = UilSquint;
