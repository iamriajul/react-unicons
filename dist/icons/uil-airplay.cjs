...
// src/icons/uil-airplay.tsx
var uil_airplay_exports = {};
__export(uil_airplay_exports, {
  default: () => uil_airplay_default
});
module.exports = __toCommonJS(uil_airplay_exports);
...
var uil_airplay_default = UilAirplay;
