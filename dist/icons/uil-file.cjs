...
// src/icons/uil-file.tsx
var uil_file_exports = {};
__export(uil_file_exports, {
  default: () => uil_file_default
});
module.exports = __toCommonJS(uil_file_exports);
