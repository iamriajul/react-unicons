...
// src/icons/uil-java-script.tsx
var uil_java_script_exports = {};
__export(uil_java_script_exports, {
  default: () => uil_java_script_default
});
module.exports = __toCommonJS(uil_java_script_exports);
var import_react = __toESM(require("react"), 1);
var UilJavaScript = (_a) => {
...
var uil_java_script_default = UilJavaScript;
