...
// src/icons/uil-bright.tsx
var uil_bright_exports = {};
__export(uil_bright_exports, {
  default: () => uil_bright_default
});
module.exports = __toCommonJS(uil_bright_exports);
...
var uil_bright_default = UilBright;
