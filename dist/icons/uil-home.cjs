...
// src/icons/uil-home.tsx
var uil_home_exports = {};
__export(uil_home_exports, {
  default: () => uil_home_default
});
module.exports = __toCommonJS(uil_home_exports);
