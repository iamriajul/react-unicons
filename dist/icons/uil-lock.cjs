...
// src/icons/uil-lock.tsx
var uil_lock_exports = {};
__export(uil_lock_exports, {
  default: () => uil_lock_default
});
module.exports = __toCommonJS(uil_lock_exports);
