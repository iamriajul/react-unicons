...
// src/icons/uil-upload.tsx
var uil_upload_exports = {};
__export(uil_upload_exports, {
  default: () => uil_upload_default
});
module.exports = __toCommonJS(uil_upload_exports);
...
var uil_upload_default = UilUpload;
