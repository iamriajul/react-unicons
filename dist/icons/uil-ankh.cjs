...
// src/icons/uil-ankh.tsx
var uil_ankh_exports = {};
__export(uil_ankh_exports, {
  default: () => uil_ankh_default
});
module.exports = __toCommonJS(uil_ankh_exports);
