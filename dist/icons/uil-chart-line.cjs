...
// src/icons/uil-chart-line.tsx
var uil_chart_line_exports = {};
__export(uil_chart_line_exports, {
  default: () => uil_chart_line_default
});
module.exports = __toCommonJS(uil_chart_line_exports);
...
var uil_chart_line_default = UilChartLine;
