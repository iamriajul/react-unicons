...
// src/icons/uil-history.tsx
var uil_history_exports = {};
__export(uil_history_exports, {
  default: () => uil_history_default
});
module.exports = __toCommonJS(uil_history_exports);
...
var uil_history_default = UilHistory;
