...
// src/icons/uil-notes.tsx
var uil_notes_exports = {};
__export(uil_notes_exports, {
  default: () => uil_notes_default
});
module.exports = __toCommonJS(uil_notes_exports);
...
var uil_notes_default = UilNotes;
