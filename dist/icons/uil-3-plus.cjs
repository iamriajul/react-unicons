...
// src/icons/uil-3-plus.tsx
var uil_3_plus_exports = {};
__export(uil_3_plus_exports, {
  default: () => uil_3_plus_default
});
module.exports = __toCommonJS(uil_3_plus_exports);
...
var uil_3_plus_default = Uil3Plus;
