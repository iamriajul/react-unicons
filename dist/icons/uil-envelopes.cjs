...
// src/icons/uil-envelopes.tsx
var uil_envelopes_exports = {};
__export(uil_envelopes_exports, {
  default: () => uil_envelopes_default
});
module.exports = __toCommonJS(uil_envelopes_exports);
...
var uil_envelopes_default = UilEnvelopes;
