...
// src/icons/uil-invoice.tsx
var uil_invoice_exports = {};
__export(uil_invoice_exports, {
  default: () => uil_invoice_default
});
module.exports = __toCommonJS(uil_invoice_exports);
...
var uil_invoice_default = UilInvoice;
