...
// src/icons/uil-dice-three.tsx
var uil_dice_three_exports = {};
__export(uil_dice_three_exports, {
  default: () => uil_dice_three_default
});
module.exports = __toCommonJS(uil_dice_three_exports);
...
var uil_dice_three_default = UilDiceThree;
