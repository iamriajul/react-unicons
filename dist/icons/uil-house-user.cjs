...
// src/icons/uil-house-user.tsx
var uil_house_user_exports = {};
__export(uil_house_user_exports, {
  default: () => uil_house_user_default
});
module.exports = __toCommonJS(uil_house_user_exports);
...
var uil_house_user_default = UilHouseUser;
