...
// src/icons/uil-list-ul.tsx
var uil_list_ul_exports = {};
__export(uil_list_ul_exports, {
  default: () => uil_list_ul_default
});
module.exports = __toCommonJS(uil_list_ul_exports);
...
var uil_list_ul_default = UilListUl;
