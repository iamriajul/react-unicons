...
// src/icons/uil-surprise.tsx
var uil_surprise_exports = {};
__export(uil_surprise_exports, {
  default: () => uil_surprise_default
});
module.exports = __toCommonJS(uil_surprise_exports);
...
var uil_surprise_default = UilSurprise;
