...
// src/icons/uil-clouds.tsx
var uil_clouds_exports = {};
__export(uil_clouds_exports, {
  default: () => uil_clouds_default
});
module.exports = __toCommonJS(uil_clouds_exports);
...
var uil_clouds_default = UilClouds;
