...
// src/icons/uil-map-marker.tsx
var uil_map_marker_exports = {};
__export(uil_map_marker_exports, {
  default: () => uil_map_marker_default
});
module.exports = __toCommonJS(uil_map_marker_exports);
...
var uil_map_marker_default = UilMapMarker;
