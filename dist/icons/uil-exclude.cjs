...
// src/icons/uil-exclude.tsx
var uil_exclude_exports = {};
__export(uil_exclude_exports, {
  default: () => uil_exclude_default
});
module.exports = __toCommonJS(uil_exclude_exports);
...
var uil_exclude_default = UilExclude;
