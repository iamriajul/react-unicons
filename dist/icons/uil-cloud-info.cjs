...
// src/icons/uil-cloud-info.tsx
var uil_cloud_info_exports = {};
__export(uil_cloud_info_exports, {
  default: () => uil_cloud_info_default
});
module.exports = __toCommonJS(uil_cloud_info_exports);
...
var uil_cloud_info_default = UilCloudInfo;
