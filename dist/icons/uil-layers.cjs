...
// src/icons/uil-layers.tsx
var uil_layers_exports = {};
__export(uil_layers_exports, {
  default: () => uil_layers_default
});
module.exports = __toCommonJS(uil_layers_exports);
...
var uil_layers_default = UilLayers;
