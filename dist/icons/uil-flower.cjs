...
// src/icons/uil-flower.tsx
var uil_flower_exports = {};
__export(uil_flower_exports, {
  default: () => uil_flower_default
});
module.exports = __toCommonJS(uil_flower_exports);
...
var uil_flower_default = UilFlower;
