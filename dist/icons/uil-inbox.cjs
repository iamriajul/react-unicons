...
// src/icons/uil-inbox.tsx
var uil_inbox_exports = {};
__export(uil_inbox_exports, {
  default: () => uil_inbox_default
});
module.exports = __toCommonJS(uil_inbox_exports);
...
var uil_inbox_default = UilInbox;
