...
// src/icons/uil-stretcher.tsx
var uil_stretcher_exports = {};
__export(uil_stretcher_exports, {
  default: () => uil_stretcher_default
});
module.exports = __toCommonJS(uil_stretcher_exports);
...
var uil_stretcher_default = UilStretcher;
