...
// src/icons/uil-save.tsx
var uil_save_exports = {};
__export(uil_save_exports, {
  default: () => uil_save_default
});
module.exports = __toCommonJS(uil_save_exports);
