...
// src/icons/uil-crosshair.tsx
var uil_crosshair_exports = {};
__export(uil_crosshair_exports, {
  default: () => uil_crosshair_default
});
module.exports = __toCommonJS(uil_crosshair_exports);
...
var uil_crosshair_default = UilCrosshair;
