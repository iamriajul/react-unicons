...
// src/icons/uil-copyright.tsx
var uil_copyright_exports = {};
__export(uil_copyright_exports, {
  default: () => uil_copyright_default
});
module.exports = __toCommonJS(uil_copyright_exports);
...
var uil_copyright_default = UilCopyright;
