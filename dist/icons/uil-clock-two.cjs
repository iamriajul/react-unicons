...
// src/icons/uil-clock-two.tsx
var uil_clock_two_exports = {};
__export(uil_clock_two_exports, {
  default: () => uil_clock_two_default
});
module.exports = __toCommonJS(uil_clock_two_exports);
...
var uil_clock_two_default = UilClockTwo;
