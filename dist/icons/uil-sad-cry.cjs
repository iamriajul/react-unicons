...
// src/icons/uil-sad-cry.tsx
var uil_sad_cry_exports = {};
__export(uil_sad_cry_exports, {
  default: () => uil_sad_cry_default
});
module.exports = __toCommonJS(uil_sad_cry_exports);
...
var uil_sad_cry_default = UilSadCry;
