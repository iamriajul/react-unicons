...
// src/icons/uil-chart-down.tsx
var uil_chart_down_exports = {};
__export(uil_chart_down_exports, {
  default: () => uil_chart_down_default
});
module.exports = __toCommonJS(uil_chart_down_exports);
...
var uil_chart_down_default = UilChartDown;
