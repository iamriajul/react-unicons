...
// src/icons/uil-smile-wink.tsx
var uil_smile_wink_exports = {};
__export(uil_smile_wink_exports, {
  default: () => uil_smile_wink_default
});
module.exports = __toCommonJS(uil_smile_wink_exports);
...
var uil_smile_wink_default = UilSmileWink;
