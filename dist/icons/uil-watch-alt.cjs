...
// src/icons/uil-watch-alt.tsx
var uil_watch_alt_exports = {};
__export(uil_watch_alt_exports, {
  default: () => uil_watch_alt_default
});
module.exports = __toCommonJS(uil_watch_alt_exports);
...
var uil_watch_alt_default = UilWatchAlt;
