...
// src/icons/uil-tornado.tsx
var uil_tornado_exports = {};
__export(uil_tornado_exports, {
  default: () => uil_tornado_default
});
module.exports = __toCommonJS(uil_tornado_exports);
...
var uil_tornado_default = UilTornado;
