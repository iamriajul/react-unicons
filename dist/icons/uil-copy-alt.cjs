...
// src/icons/uil-copy-alt.tsx
var uil_copy_alt_exports = {};
__export(uil_copy_alt_exports, {
  default: () => uil_copy_alt_default
});
module.exports = __toCommonJS(uil_copy_alt_exports);
...
var uil_copy_alt_default = UilCopyAlt;
