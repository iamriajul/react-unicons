...
// src/icons/uil-sick.tsx
var uil_sick_exports = {};
__export(uil_sick_exports, {
  default: () => uil_sick_default
});
module.exports = __toCommonJS(uil_sick_exports);
