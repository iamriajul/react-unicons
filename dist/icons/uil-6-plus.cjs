...
// src/icons/uil-6-plus.tsx
var uil_6_plus_exports = {};
__export(uil_6_plus_exports, {
  default: () => uil_6_plus_default
});
module.exports = __toCommonJS(uil_6_plus_exports);
...
var uil_6_plus_default = Uil6Plus;
