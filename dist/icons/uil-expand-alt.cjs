...
// src/icons/uil-expand-alt.tsx
var uil_expand_alt_exports = {};
__export(uil_expand_alt_exports, {
  default: () => uil_expand_alt_default
});
module.exports = __toCommonJS(uil_expand_alt_exports);
...
var uil_expand_alt_default = UilExpandAlt;
