...
// src/icons/uil-browser.tsx
var uil_browser_exports = {};
__export(uil_browser_exports, {
  default: () => uil_browser_default
});
module.exports = __toCommonJS(uil_browser_exports);
...
var uil_browser_default = UilBrowser;
