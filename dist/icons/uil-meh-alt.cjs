...
// src/icons/uil-meh-alt.tsx
var uil_meh_alt_exports = {};
__export(uil_meh_alt_exports, {
  default: () => uil_meh_alt_default
});
module.exports = __toCommonJS(uil_meh_alt_exports);
...
var uil_meh_alt_default = UilMehAlt;
