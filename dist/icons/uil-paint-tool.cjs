...
// src/icons/uil-paint-tool.tsx
var uil_paint_tool_exports = {};
__export(uil_paint_tool_exports, {
  default: () => uil_paint_tool_default
});
module.exports = __toCommonJS(uil_paint_tool_exports);
...
var uil_paint_tool_default = UilPaintTool;
