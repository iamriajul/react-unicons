...
// src/icons/uil-shrink.tsx
var uil_shrink_exports = {};
__export(uil_shrink_exports, {
  default: () => uil_shrink_default
});
module.exports = __toCommonJS(uil_shrink_exports);
...
var uil_shrink_default = UilShrink;
