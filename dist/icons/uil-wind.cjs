...
// src/icons/uil-wind.tsx
var uil_wind_exports = {};
__export(uil_wind_exports, {
  default: () => uil_wind_default
});
module.exports = __toCommonJS(uil_wind_exports);
