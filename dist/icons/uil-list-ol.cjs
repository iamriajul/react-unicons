...
// src/icons/uil-list-ol.tsx
var uil_list_ol_exports = {};
__export(uil_list_ol_exports, {
  default: () => uil_list_ol_default
});
module.exports = __toCommonJS(uil_list_ol_exports);
...
var uil_list_ol_default = UilListOl;
