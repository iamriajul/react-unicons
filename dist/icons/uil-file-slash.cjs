...
// src/icons/uil-file-slash.tsx
var uil_file_slash_exports = {};
__export(uil_file_slash_exports, {
  default: () => uil_file_slash_default
});
module.exports = __toCommonJS(uil_file_slash_exports);
...
var uil_file_slash_default = UilFileSlash;
