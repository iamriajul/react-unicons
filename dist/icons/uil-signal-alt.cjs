...
// src/icons/uil-signal-alt.tsx
var uil_signal_alt_exports = {};
__export(uil_signal_alt_exports, {
  default: () => uil_signal_alt_default
});
module.exports = __toCommonJS(uil_signal_alt_exports);
...
var uil_signal_alt_default = UilSignalAlt;
