...
// src/icons/uil-bookmark.tsx
var uil_bookmark_exports = {};
__export(uil_bookmark_exports, {
  default: () => uil_bookmark_default
});
module.exports = __toCommonJS(uil_bookmark_exports);
...
var uil_bookmark_default = UilBookmark;
