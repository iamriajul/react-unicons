...
// src/icons/uil-polygon.tsx
var uil_polygon_exports = {};
__export(uil_polygon_exports, {
  default: () => uil_polygon_default
});
module.exports = __toCommonJS(uil_polygon_exports);
...
var uil_polygon_default = UilPolygon;
