...
// src/icons/uil-grin.tsx
var uil_grin_exports = {};
__export(uil_grin_exports, {
  default: () => uil_grin_default
});
module.exports = __toCommonJS(uil_grin_exports);
