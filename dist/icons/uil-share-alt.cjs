...
// src/icons/uil-share-alt.tsx
var uil_share_alt_exports = {};
__export(uil_share_alt_exports, {
  default: () => uil_share_alt_default
});
module.exports = __toCommonJS(uil_share_alt_exports);
...
var uil_share_alt_default = UilShareAlt;
