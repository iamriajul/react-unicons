...
// src/icons/uil-pound.tsx
var uil_pound_exports = {};
__export(uil_pound_exports, {
  default: () => uil_pound_default
});
module.exports = __toCommonJS(uil_pound_exports);
...
var uil_pound_default = UilPound;
