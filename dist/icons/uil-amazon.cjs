...
// src/icons/uil-amazon.tsx
var uil_amazon_exports = {};
__export(uil_amazon_exports, {
  default: () => uil_amazon_default
});
module.exports = __toCommonJS(uil_amazon_exports);
...
var uil_amazon_default = UilAmazon;
