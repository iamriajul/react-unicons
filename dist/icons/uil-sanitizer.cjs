...
// src/icons/uil-sanitizer.tsx
var uil_sanitizer_exports = {};
__export(uil_sanitizer_exports, {
  default: () => uil_sanitizer_default
});
module.exports = __toCommonJS(uil_sanitizer_exports);
...
var uil_sanitizer_default = UilSanitizer;
