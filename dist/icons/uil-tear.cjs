...
// src/icons/uil-tear.tsx
var uil_tear_exports = {};
__export(uil_tear_exports, {
  default: () => uil_tear_default
});
module.exports = __toCommonJS(uil_tear_exports);
