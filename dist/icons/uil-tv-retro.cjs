...
// src/icons/uil-tv-retro.tsx
var uil_tv_retro_exports = {};
__export(uil_tv_retro_exports, {
  default: () => uil_tv_retro_default
});
module.exports = __toCommonJS(uil_tv_retro_exports);
...
var uil_tv_retro_default = UilTvRetro;
