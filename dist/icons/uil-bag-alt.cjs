...
// src/icons/uil-bag-alt.tsx
var uil_bag_alt_exports = {};
__export(uil_bag_alt_exports, {
  default: () => uil_bag_alt_default
});
module.exports = __toCommonJS(uil_bag_alt_exports);
...
var uil_bag_alt_default = UilBagAlt;
