...
// src/icons/uil-webcam.tsx
var uil_webcam_exports = {};
__export(uil_webcam_exports, {
  default: () => uil_webcam_default
});
module.exports = __toCommonJS(uil_webcam_exports);
...
var uil_webcam_default = UilWebcam;
