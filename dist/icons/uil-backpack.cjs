...
// src/icons/uil-backpack.tsx
var uil_backpack_exports = {};
__export(uil_backpack_exports, {
  default: () => uil_backpack_default
});
module.exports = __toCommonJS(uil_backpack_exports);
...
var uil_backpack_default = UilBackpack;
