...
// src/icons/uil-discord.tsx
var uil_discord_exports = {};
__export(uil_discord_exports, {
  default: () => uil_discord_default
});
module.exports = __toCommonJS(uil_discord_exports);
...
var uil_discord_default = UilDiscord;
