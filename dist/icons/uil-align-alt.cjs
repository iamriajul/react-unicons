...
// src/icons/uil-align-alt.tsx
var uil_align_alt_exports = {};
__export(uil_align_alt_exports, {
  default: () => uil_align_alt_default
});
module.exports = __toCommonJS(uil_align_alt_exports);
...
var uil_align_alt_default = UilAlignAlt;
