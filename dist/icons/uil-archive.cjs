...
// src/icons/uil-archive.tsx
var uil_archive_exports = {};
__export(uil_archive_exports, {
  default: () => uil_archive_default
});
module.exports = __toCommonJS(uil_archive_exports);
...
var uil_archive_default = UilArchive;
