...
// src/icons/uil-link-alt.tsx
var uil_link_alt_exports = {};
__export(uil_link_alt_exports, {
  default: () => uil_link_alt_default
});
module.exports = __toCommonJS(uil_link_alt_exports);
...
var uil_link_alt_default = UilLinkAlt;
