...
// src/icons/uil-pump.tsx
var uil_pump_exports = {};
__export(uil_pump_exports, {
  default: () => uil_pump_default
});
module.exports = __toCommonJS(uil_pump_exports);
