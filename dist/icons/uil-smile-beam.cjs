...
// src/icons/uil-smile-beam.tsx
var uil_smile_beam_exports = {};
__export(uil_smile_beam_exports, {
  default: () => uil_smile_beam_default
});
module.exports = __toCommonJS(uil_smile_beam_exports);
...
var uil_smile_beam_default = UilSmileBeam;
