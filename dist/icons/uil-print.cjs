...
// src/icons/uil-print.tsx
var uil_print_exports = {};
__export(uil_print_exports, {
  default: () => uil_print_default
});
module.exports = __toCommonJS(uil_print_exports);
...
var uil_print_default = UilPrint;
