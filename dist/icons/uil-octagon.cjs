...
// src/icons/uil-octagon.tsx
var uil_octagon_exports = {};
__export(uil_octagon_exports, {
  default: () => uil_octagon_default
});
module.exports = __toCommonJS(uil_octagon_exports);
...
var uil_octagon_default = UilOctagon;
