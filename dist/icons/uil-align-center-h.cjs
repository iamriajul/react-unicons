...
var uil_align_center_h_exports = {};
__export(uil_align_center_h_exports, {
  default: () => uil_align_center_h_default
});
module.exports = __toCommonJS(uil_align_center_h_exports);
