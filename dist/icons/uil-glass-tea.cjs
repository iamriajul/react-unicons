...
// src/icons/uil-glass-tea.tsx
var uil_glass_tea_exports = {};
__export(uil_glass_tea_exports, {
  default: () => uil_glass_tea_default
});
module.exports = __toCommonJS(uil_glass_tea_exports);
...
var uil_glass_tea_default = UilGlassTea;
