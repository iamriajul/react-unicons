...
// src/icons/uil-arrows-v.tsx
var uil_arrows_v_exports = {};
__export(uil_arrows_v_exports, {
  default: () => uil_arrows_v_default
});
module.exports = __toCommonJS(uil_arrows_v_exports);
...
var uil_arrows_v_default = UilArrowsV;
