...
// src/icons/uil-user-check.tsx
var uil_user_check_exports = {};
__export(uil_user_check_exports, {
  default: () => uil_user_check_default
});
module.exports = __toCommonJS(uil_user_check_exports);
...
var uil_user_check_default = UilUserCheck;
