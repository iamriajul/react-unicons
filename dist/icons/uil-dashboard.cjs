...
// src/icons/uil-dashboard.tsx
var uil_dashboard_exports = {};
__export(uil_dashboard_exports, {
  default: () => uil_dashboard_default
});
module.exports = __toCommonJS(uil_dashboard_exports);
...
var uil_dashboard_default = UilDashboard;
