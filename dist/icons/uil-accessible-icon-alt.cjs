...
// src/icons/uil-accessible-icon-alt.tsx
var uil_accessible_icon_alt_exports = {};
__export(uil_accessible_icon_alt_exports, {
  default: () => uil_accessible_icon_alt_default
});
module.exports = __toCommonJS(uil_accessible_icon_alt_exports);
var import_react = __toESM(require("react"), 1);
var UilAccessibleIconAlt = (_a) => {
...
var uil_accessible_icon_alt_default = UilAccessibleIconAlt;
