...
// src/icons/uil-yen-circle.tsx
var uil_yen_circle_exports = {};
__export(uil_yen_circle_exports, {
  default: () => uil_yen_circle_default
});
module.exports = __toCommonJS(uil_yen_circle_exports);
...
var uil_yen_circle_default = UilYenCircle;
