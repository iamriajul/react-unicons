...
// src/icons/uil-wallet.tsx
var uil_wallet_exports = {};
__export(uil_wallet_exports, {
  default: () => uil_wallet_default
});
module.exports = __toCommonJS(uil_wallet_exports);
...
var uil_wallet_default = UilWallet;
