...
// src/icons/uil-border-out.tsx
var uil_border_out_exports = {};
__export(uil_border_out_exports, {
  default: () => uil_border_out_default
});
module.exports = __toCommonJS(uil_border_out_exports);
...
var uil_border_out_default = UilBorderOut;
