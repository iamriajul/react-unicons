...
// src/icons/uil-envelope.tsx
var uil_envelope_exports = {};
__export(uil_envelope_exports, {
  default: () => uil_envelope_default
});
module.exports = __toCommonJS(uil_envelope_exports);
...
var uil_envelope_default = UilEnvelope;
