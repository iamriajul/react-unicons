...
// src/icons/uil-github-alt.tsx
var uil_github_alt_exports = {};
__export(uil_github_alt_exports, {
  default: () => uil_github_alt_default
});
module.exports = __toCommonJS(uil_github_alt_exports);
...
var uil_github_alt_default = UilGithubAlt;
