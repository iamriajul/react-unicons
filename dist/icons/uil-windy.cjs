...
// src/icons/uil-windy.tsx
var uil_windy_exports = {};
__export(uil_windy_exports, {
  default: () => uil_windy_default
});
module.exports = __toCommonJS(uil_windy_exports);
...
var uil_windy_default = UilWindy;
