...
// src/icons/uil-map-pin-alt.tsx
var uil_map_pin_alt_exports = {};
__export(uil_map_pin_alt_exports, {
  default: () => uil_map_pin_alt_default
});
module.exports = __toCommonJS(uil_map_pin_alt_exports);
...
var uil_map_pin_alt_default = UilMapPinAlt;
