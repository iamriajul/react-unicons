...
// src/icons/uil-drill.tsx
var uil_drill_exports = {};
__export(uil_drill_exports, {
  default: () => uil_drill_default
});
module.exports = __toCommonJS(uil_drill_exports);
...
var uil_drill_default = UilDrill;
