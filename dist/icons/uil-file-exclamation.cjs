...
var uil_file_exclamation_exports = {};
__export(uil_file_exclamation_exports, {
  default: () => uil_file_exclamation_default
});
module.exports = __toCommonJS(uil_file_exclamation_exports);
