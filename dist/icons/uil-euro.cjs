...
// src/icons/uil-euro.tsx
var uil_euro_exports = {};
__export(uil_euro_exports, {
  default: () => uil_euro_default
});
module.exports = __toCommonJS(uil_euro_exports);
