...
// src/icons/uil-building.tsx
var uil_building_exports = {};
__export(uil_building_exports, {
  default: () => uil_building_default
});
module.exports = __toCommonJS(uil_building_exports);
...
var uil_building_default = UilBuilding;
