...
// src/icons/uil-parcel.tsx
var uil_parcel_exports = {};
__export(uil_parcel_exports, {
  default: () => uil_parcel_default
});
module.exports = __toCommonJS(uil_parcel_exports);
...
var uil_parcel_default = UilParcel;
