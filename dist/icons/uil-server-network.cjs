...
// src/icons/uil-server-network.tsx
var uil_server_network_exports = {};
__export(uil_server_network_exports, {
  default: () => uil_server_network_default
});
module.exports = __toCommonJS(uil_server_network_exports);
var import_react = __toESM(require("react"), 1);
var UilServerNetwork = (_a) => {
...
var uil_server_network_default = UilServerNetwork;
