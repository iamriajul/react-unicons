...
// src/icons/uil-capture.tsx
var uil_capture_exports = {};
__export(uil_capture_exports, {
  default: () => uil_capture_default
});
module.exports = __toCommonJS(uil_capture_exports);
...
var uil_capture_default = UilCapture;
