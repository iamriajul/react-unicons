...
// src/icons/uil-bolt-alt.tsx
var uil_bolt_alt_exports = {};
__export(uil_bolt_alt_exports, {
  default: () => uil_bolt_alt_default
});
module.exports = __toCommonJS(uil_bolt_alt_exports);
...
var uil_bolt_alt_default = UilBoltAlt;
