...
// src/icons/uil-rainbow.tsx
var uil_rainbow_exports = {};
__export(uil_rainbow_exports, {
  default: () => uil_rainbow_default
});
module.exports = __toCommonJS(uil_rainbow_exports);
...
var uil_rainbow_default = UilRainbow;
