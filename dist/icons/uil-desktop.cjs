...
// src/icons/uil-desktop.tsx
var uil_desktop_exports = {};
__export(uil_desktop_exports, {
  default: () => uil_desktop_default
});
module.exports = __toCommonJS(uil_desktop_exports);
...
var uil_desktop_default = UilDesktop;
