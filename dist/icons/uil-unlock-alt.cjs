...
// src/icons/uil-unlock-alt.tsx
var uil_unlock_alt_exports = {};
__export(uil_unlock_alt_exports, {
  default: () => uil_unlock_alt_default
});
module.exports = __toCommonJS(uil_unlock_alt_exports);
...
var uil_unlock_alt_default = UilUnlockAlt;
