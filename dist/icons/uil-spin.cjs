...
// src/icons/uil-spin.tsx
var uil_spin_exports = {};
__export(uil_spin_exports, {
  default: () => uil_spin_default
});
module.exports = __toCommonJS(uil_spin_exports);
