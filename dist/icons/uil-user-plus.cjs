...
// src/icons/uil-user-plus.tsx
var uil_user_plus_exports = {};
__export(uil_user_plus_exports, {
  default: () => uil_user_plus_default
});
module.exports = __toCommonJS(uil_user_plus_exports);
...
var uil_user_plus_default = UilUserPlus;
