...
// src/icons/uil-brush-alt.tsx
var uil_brush_alt_exports = {};
__export(uil_brush_alt_exports, {
  default: () => uil_brush_alt_default
});
module.exports = __toCommonJS(uil_brush_alt_exports);
...
var uil_brush_alt_default = UilBrushAlt;
