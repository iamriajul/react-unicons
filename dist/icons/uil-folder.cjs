...
// src/icons/uil-folder.tsx
var uil_folder_exports = {};
__export(uil_folder_exports, {
  default: () => uil_folder_default
});
module.exports = __toCommonJS(uil_folder_exports);
...
var uil_folder_default = UilFolder;
