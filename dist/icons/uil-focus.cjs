...
// src/icons/uil-focus.tsx
var uil_focus_exports = {};
__export(uil_focus_exports, {
  default: () => uil_focus_default
});
module.exports = __toCommonJS(uil_focus_exports);
...
var uil_focus_default = UilFocus;
