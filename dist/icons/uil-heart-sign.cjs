...
// src/icons/uil-heart-sign.tsx
var uil_heart_sign_exports = {};
__export(uil_heart_sign_exports, {
  default: () => uil_heart_sign_default
});
module.exports = __toCommonJS(uil_heart_sign_exports);
...
var uil_heart_sign_default = UilHeartSign;
