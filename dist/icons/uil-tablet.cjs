...
// src/icons/uil-tablet.tsx
var uil_tablet_exports = {};
__export(uil_tablet_exports, {
  default: () => uil_tablet_default
});
module.exports = __toCommonJS(uil_tablet_exports);
...
var uil_tablet_default = UilTablet;
