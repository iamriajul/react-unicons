...
// src/icons/uil-table.tsx
var uil_table_exports = {};
__export(uil_table_exports, {
  default: () => uil_table_default
});
module.exports = __toCommonJS(uil_table_exports);
...
var uil_table_default = UilTable;
