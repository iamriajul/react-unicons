...
// src/icons/uil-bold.tsx
var uil_bold_exports = {};
__export(uil_bold_exports, {
  default: () => uil_bold_default
});
module.exports = __toCommonJS(uil_bold_exports);
