...
// src/icons/uil-paperclip.tsx
var uil_paperclip_exports = {};
__export(uil_paperclip_exports, {
  default: () => uil_paperclip_default
});
module.exports = __toCommonJS(uil_paperclip_exports);
...
var uil_paperclip_default = UilPaperclip;
