...
// src/icons/uil-volume.tsx
var uil_volume_exports = {};
__export(uil_volume_exports, {
  default: () => uil_volume_default
});
module.exports = __toCommonJS(uil_volume_exports);
...
var uil_volume_default = UilVolume;
