...
// src/icons/uil-sigma.tsx
var uil_sigma_exports = {};
__export(uil_sigma_exports, {
  default: () => uil_sigma_default
});
module.exports = __toCommonJS(uil_sigma_exports);
...
var uil_sigma_default = UilSigma;
