...
// src/icons/uil-process.tsx
var uil_process_exports = {};
__export(uil_process_exports, {
  default: () => uil_process_default
});
module.exports = __toCommonJS(uil_process_exports);
...
var uil_process_default = UilProcess;
