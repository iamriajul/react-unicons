...
// src/icons/uil-card-atm.tsx
var uil_card_atm_exports = {};
__export(uil_card_atm_exports, {
  default: () => uil_card_atm_default
});
module.exports = __toCommonJS(uil_card_atm_exports);
...
var uil_card_atm_default = UilCardAtm;
