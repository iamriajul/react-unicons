...
// src/icons/uil-postcard.tsx
var uil_postcard_exports = {};
__export(uil_postcard_exports, {
  default: () => uil_postcard_default
});
module.exports = __toCommonJS(uil_postcard_exports);
...
var uil_postcard_default = UilPostcard;
