...
// src/icons/uil-football.tsx
var uil_football_exports = {};
__export(uil_football_exports, {
  default: () => uil_football_default
});
module.exports = __toCommonJS(uil_football_exports);
...
var uil_football_default = UilFootball;
