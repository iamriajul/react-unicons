...
// src/icons/uil-thumbs-up.tsx
var uil_thumbs_up_exports = {};
__export(uil_thumbs_up_exports, {
  default: () => uil_thumbs_up_default
});
module.exports = __toCommonJS(uil_thumbs_up_exports);
...
var uil_thumbs_up_default = UilThumbsUp;
