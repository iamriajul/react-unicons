...
// src/icons/uil-bill.tsx
var uil_bill_exports = {};
__export(uil_bill_exports, {
  default: () => uil_bill_default
});
module.exports = __toCommonJS(uil_bill_exports);
