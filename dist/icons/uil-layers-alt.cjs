...
// src/icons/uil-layers-alt.tsx
var uil_layers_alt_exports = {};
__export(uil_layers_alt_exports, {
  default: () => uil_layers_alt_default
});
module.exports = __toCommonJS(uil_layers_alt_exports);
...
var uil_layers_alt_default = UilLayersAlt;
