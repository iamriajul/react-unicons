...
// src/icons/uil-laptop.tsx
var uil_laptop_exports = {};
__export(uil_laptop_exports, {
  default: () => uil_laptop_default
});
module.exports = __toCommonJS(uil_laptop_exports);
...
var uil_laptop_default = UilLaptop;
