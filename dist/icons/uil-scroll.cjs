...
// src/icons/uil-scroll.tsx
var uil_scroll_exports = {};
__export(uil_scroll_exports, {
  default: () => uil_scroll_default
});
module.exports = __toCommonJS(uil_scroll_exports);
...
var uil_scroll_default = UilScroll;
