...
// src/icons/uil-heart-alt.tsx
var uil_heart_alt_exports = {};
__export(uil_heart_alt_exports, {
  default: () => uil_heart_alt_default
});
module.exports = __toCommonJS(uil_heart_alt_exports);
...
var uil_heart_alt_default = UilHeartAlt;
