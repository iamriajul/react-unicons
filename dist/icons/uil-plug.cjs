...
// src/icons/uil-plug.tsx
var uil_plug_exports = {};
__export(uil_plug_exports, {
  default: () => uil_plug_default
});
module.exports = __toCommonJS(uil_plug_exports);
