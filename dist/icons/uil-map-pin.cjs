...
// src/icons/uil-map-pin.tsx
var uil_map_pin_exports = {};
__export(uil_map_pin_exports, {
  default: () => uil_map_pin_default
});
module.exports = __toCommonJS(uil_map_pin_exports);
...
var uil_map_pin_default = UilMapPin;
