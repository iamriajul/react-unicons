...
// src/icons/uil-dice-two.tsx
var uil_dice_two_exports = {};
__export(uil_dice_two_exports, {
  default: () => uil_dice_two_default
});
module.exports = __toCommonJS(uil_dice_two_exports);
...
var uil_dice_two_default = UilDiceTwo;
