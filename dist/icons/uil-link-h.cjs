...
// src/icons/uil-link-h.tsx
var uil_link_h_exports = {};
__export(uil_link_h_exports, {
  default: () => uil_link_h_default
});
module.exports = __toCommonJS(uil_link_h_exports);
...
var uil_link_h_default = UilLinkH;
