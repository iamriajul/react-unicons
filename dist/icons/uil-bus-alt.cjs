...
// src/icons/uil-bus-alt.tsx
var uil_bus_alt_exports = {};
__export(uil_bus_alt_exports, {
  default: () => uil_bus_alt_default
});
module.exports = __toCommonJS(uil_bus_alt_exports);
...
var uil_bus_alt_default = UilBusAlt;
