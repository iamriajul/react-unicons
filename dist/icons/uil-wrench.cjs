...
// src/icons/uil-wrench.tsx
var uil_wrench_exports = {};
__export(uil_wrench_exports, {
  default: () => uil_wrench_default
});
module.exports = __toCommonJS(uil_wrench_exports);
...
var uil_wrench_default = UilWrench;
