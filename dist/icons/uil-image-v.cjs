...
// src/icons/uil-image-v.tsx
var uil_image_v_exports = {};
__export(uil_image_v_exports, {
  default: () => uil_image_v_default
});
module.exports = __toCommonJS(uil_image_v_exports);
...
var uil_image_v_default = UilImageV;
