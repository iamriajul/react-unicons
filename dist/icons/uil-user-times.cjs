...
// src/icons/uil-user-times.tsx
var uil_user_times_exports = {};
__export(uil_user_times_exports, {
  default: () => uil_user_times_default
});
module.exports = __toCommonJS(uil_user_times_exports);
...
var uil_user_times_default = UilUserTimes;
