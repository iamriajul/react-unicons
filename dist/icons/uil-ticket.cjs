...
// src/icons/uil-ticket.tsx
var uil_ticket_exports = {};
__export(uil_ticket_exports, {
  default: () => uil_ticket_default
});
module.exports = __toCommonJS(uil_ticket_exports);
...
var uil_ticket_default = UilTicket;
