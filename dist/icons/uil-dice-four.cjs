...
// src/icons/uil-dice-four.tsx
var uil_dice_four_exports = {};
__export(uil_dice_four_exports, {
  default: () => uil_dice_four_default
});
module.exports = __toCommonJS(uil_dice_four_exports);
...
var uil_dice_four_default = UilDiceFour;
