...
// src/icons/uil-bullseye.tsx
var uil_bullseye_exports = {};
__export(uil_bullseye_exports, {
  default: () => uil_bullseye_default
});
module.exports = __toCommonJS(uil_bullseye_exports);
...
var uil_bullseye_default = UilBullseye;
