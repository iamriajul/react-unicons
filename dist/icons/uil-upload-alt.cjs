...
// src/icons/uil-upload-alt.tsx
var uil_upload_alt_exports = {};
__export(uil_upload_alt_exports, {
  default: () => uil_upload_alt_default
});
module.exports = __toCommonJS(uil_upload_alt_exports);
...
var uil_upload_alt_default = UilUploadAlt;
