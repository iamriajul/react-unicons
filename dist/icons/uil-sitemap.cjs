...
// src/icons/uil-sitemap.tsx
var uil_sitemap_exports = {};
__export(uil_sitemap_exports, {
  default: () => uil_sitemap_default
});
module.exports = __toCommonJS(uil_sitemap_exports);
...
var uil_sitemap_default = UilSitemap;
