...
// src/icons/uil-mars.tsx
var uil_mars_exports = {};
__export(uil_mars_exports, {
  default: () => uil_mars_default
});
module.exports = __toCommonJS(uil_mars_exports);
