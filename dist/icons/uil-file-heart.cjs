...
// src/icons/uil-file-heart.tsx
var uil_file_heart_exports = {};
__export(uil_file_heart_exports, {
  default: () => uil_file_heart_default
});
module.exports = __toCommonJS(uil_file_heart_exports);
...
var uil_file_heart_default = UilFileHeart;
