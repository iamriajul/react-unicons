...
// src/icons/uil-frown.tsx
var uil_frown_exports = {};
__export(uil_frown_exports, {
  default: () => uil_frown_default
});
module.exports = __toCommonJS(uil_frown_exports);
...
var uil_frown_default = UilFrown;
