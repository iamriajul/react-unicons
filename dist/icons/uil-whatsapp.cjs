...
// src/icons/uil-whatsapp.tsx
var uil_whatsapp_exports = {};
__export(uil_whatsapp_exports, {
  default: () => uil_whatsapp_default
});
module.exports = __toCommonJS(uil_whatsapp_exports);
...
var uil_whatsapp_default = UilWhatsapp;
