...
// src/icons/uil-sort.tsx
var uil_sort_exports = {};
__export(uil_sort_exports, {
  default: () => uil_sort_default
});
module.exports = __toCommonJS(uil_sort_exports);
