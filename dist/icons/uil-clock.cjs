...
// src/icons/uil-clock.tsx
var uil_clock_exports = {};
__export(uil_clock_exports, {
  default: () => uil_clock_default
});
module.exports = __toCommonJS(uil_clock_exports);
...
var uil_clock_default = UilClock;
