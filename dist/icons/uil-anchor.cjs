...
// src/icons/uil-anchor.tsx
var uil_anchor_exports = {};
__export(uil_anchor_exports, {
  default: () => uil_anchor_default
});
module.exports = __toCommonJS(uil_anchor_exports);
...
var uil_anchor_default = UilAnchor;
