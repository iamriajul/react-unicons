...
// src/icons/uil-signal.tsx
var uil_signal_exports = {};
__export(uil_signal_exports, {
  default: () => uil_signal_default
});
module.exports = __toCommonJS(uil_signal_exports);
...
var uil_signal_default = UilSignal;
