...
// src/icons/uil-bell.tsx
var uil_bell_exports = {};
__export(uil_bell_exports, {
  default: () => uil_bell_default
});
module.exports = __toCommonJS(uil_bell_exports);
