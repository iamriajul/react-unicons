...
// src/icons/uil-star.tsx
var uil_star_exports = {};
__export(uil_star_exports, {
  default: () => uil_star_default
});
module.exports = __toCommonJS(uil_star_exports);
