...
// src/icons/uil-dice-six.tsx
var uil_dice_six_exports = {};
__export(uil_dice_six_exports, {
  default: () => uil_dice_six_default
});
module.exports = __toCommonJS(uil_dice_six_exports);
...
var uil_dice_six_default = UilDiceSix;
