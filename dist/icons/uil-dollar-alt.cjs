...
// src/icons/uil-dollar-alt.tsx
var uil_dollar_alt_exports = {};
__export(uil_dollar_alt_exports, {
  default: () => uil_dollar_alt_default
});
module.exports = __toCommonJS(uil_dollar_alt_exports);
...
var uil_dollar_alt_default = UilDollarAlt;
