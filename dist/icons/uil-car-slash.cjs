...
// src/icons/uil-car-slash.tsx
var uil_car_slash_exports = {};
__export(uil_car_slash_exports, {
  default: () => uil_car_slash_default
});
module.exports = __toCommonJS(uil_car_slash_exports);
...
var uil_car_slash_default = UilCarSlash;
