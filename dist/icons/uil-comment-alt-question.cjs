...
var uil_comment_alt_question_exports = {};
__export(uil_comment_alt_question_exports, {
  default: () => uil_comment_alt_question_default
});
module.exports = __toCommonJS(uil_comment_alt_question_exports);
