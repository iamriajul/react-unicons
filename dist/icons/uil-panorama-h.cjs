...
// src/icons/uil-panorama-h.tsx
var uil_panorama_h_exports = {};
__export(uil_panorama_h_exports, {
  default: () => uil_panorama_h_default
});
module.exports = __toCommonJS(uil_panorama_h_exports);
...
var uil_panorama_h_default = UilPanoramaH;
