...
// src/icons/uil-ambulance.tsx
var uil_ambulance_exports = {};
__export(uil_ambulance_exports, {
  default: () => uil_ambulance_default
});
module.exports = __toCommonJS(uil_ambulance_exports);
...
var uil_ambulance_default = UilAmbulance;
