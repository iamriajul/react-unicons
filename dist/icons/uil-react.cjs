...
// src/icons/uil-react.tsx
var uil_react_exports = {};
__export(uil_react_exports, {
  default: () => uil_react_default
});
module.exports = __toCommonJS(uil_react_exports);
...
var uil_react_default = UilReact;
