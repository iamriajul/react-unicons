...
// src/icons/uil-direction.tsx
var uil_direction_exports = {};
__export(uil_direction_exports, {
  default: () => uil_direction_default
});
module.exports = __toCommonJS(uil_direction_exports);
...
var uil_direction_default = UilDirection;
