...
// src/icons/uil-sign-alt.tsx
var uil_sign_alt_exports = {};
__export(uil_sign_alt_exports, {
  default: () => uil_sign_alt_default
});
module.exports = __toCommonJS(uil_sign_alt_exports);
...
var uil_sign_alt_default = UilSignAlt;
