...
// src/icons/uil-border-alt.tsx
var uil_border_alt_exports = {};
__export(uil_border_alt_exports, {
  default: () => uil_border_alt_default
});
module.exports = __toCommonJS(uil_border_alt_exports);
...
var uil_border_alt_default = UilBorderAlt;
