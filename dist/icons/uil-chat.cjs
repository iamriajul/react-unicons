...
// src/icons/uil-chat.tsx
var uil_chat_exports = {};
__export(uil_chat_exports, {
  default: () => uil_chat_default
});
module.exports = __toCommonJS(uil_chat_exports);
