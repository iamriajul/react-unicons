...
// src/icons/uil-image-plus.tsx
var uil_image_plus_exports = {};
__export(uil_image_plus_exports, {
  default: () => uil_image_plus_default
});
module.exports = __toCommonJS(uil_image_plus_exports);
...
var uil_image_plus_default = UilImagePlus;
