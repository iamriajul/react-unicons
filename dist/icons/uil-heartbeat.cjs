...
// src/icons/uil-heartbeat.tsx
var uil_heartbeat_exports = {};
__export(uil_heartbeat_exports, {
  default: () => uil_heartbeat_default
});
module.exports = __toCommonJS(uil_heartbeat_exports);
...
var uil_heartbeat_default = UilHeartbeat;
