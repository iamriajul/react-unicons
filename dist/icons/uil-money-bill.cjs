...
// src/icons/uil-money-bill.tsx
var uil_money_bill_exports = {};
__export(uil_money_bill_exports, {
  default: () => uil_money_bill_default
});
module.exports = __toCommonJS(uil_money_bill_exports);
...
var uil_money_bill_default = UilMoneyBill;
