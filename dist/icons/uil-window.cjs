...
// src/icons/uil-window.tsx
var uil_window_exports = {};
__export(uil_window_exports, {
  default: () => uil_window_default
});
module.exports = __toCommonJS(uil_window_exports);
...
var uil_window_default = UilWindow;
