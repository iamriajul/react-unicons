...
// src/icons/uil-sign-out-alt.tsx
var uil_sign_out_alt_exports = {};
__export(uil_sign_out_alt_exports, {
  default: () => uil_sign_out_alt_default
});
module.exports = __toCommonJS(uil_sign_out_alt_exports);
var import_react = __toESM(require("react"), 1);
var UilSignOutAlt = (_a) => {
