...
// src/icons/uil-mailbox.tsx
var uil_mailbox_exports = {};
__export(uil_mailbox_exports, {
  default: () => uil_mailbox_default
});
module.exports = __toCommonJS(uil_mailbox_exports);
...
var uil_mailbox_default = UilMailbox;
