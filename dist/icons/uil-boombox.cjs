...
// src/icons/uil-boombox.tsx
var uil_boombox_exports = {};
__export(uil_boombox_exports, {
  default: () => uil_boombox_default
});
module.exports = __toCommonJS(uil_boombox_exports);
...
var uil_boombox_default = UilBoombox;
