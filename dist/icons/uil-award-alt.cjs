...
// src/icons/uil-award-alt.tsx
var uil_award_alt_exports = {};
__export(uil_award_alt_exports, {
  default: () => uil_award_alt_default
});
module.exports = __toCommonJS(uil_award_alt_exports);
...
var uil_award_alt_default = UilAwardAlt;
