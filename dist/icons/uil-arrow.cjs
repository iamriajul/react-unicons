...
// src/icons/uil-arrow.tsx
var uil_arrow_exports = {};
__export(uil_arrow_exports, {
  default: () => uil_arrow_default
});
module.exports = __toCommonJS(uil_arrow_exports);
...
var uil_arrow_default = UilArrow;
