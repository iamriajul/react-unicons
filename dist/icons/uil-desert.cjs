...
// src/icons/uil-desert.tsx
var uil_desert_exports = {};
__export(uil_desert_exports, {
  default: () => uil_desert_default
});
module.exports = __toCommonJS(uil_desert_exports);
...
var uil_desert_default = UilDesert;
