...
// src/icons/uil-kayak.tsx
var uil_kayak_exports = {};
__export(uil_kayak_exports, {
  default: () => uil_kayak_default
});
module.exports = __toCommonJS(uil_kayak_exports);
...
var uil_kayak_default = UilKayak;
