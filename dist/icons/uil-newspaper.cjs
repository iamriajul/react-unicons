...
// src/icons/uil-newspaper.tsx
var uil_newspaper_exports = {};
__export(uil_newspaper_exports, {
  default: () => uil_newspaper_default
});
module.exports = __toCommonJS(uil_newspaper_exports);
...
var uil_newspaper_default = UilNewspaper;
