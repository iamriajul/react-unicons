...
// src/icons/uil-server-connection.tsx
var uil_server_connection_exports = {};
__export(uil_server_connection_exports, {
  default: () => uil_server_connection_default
});
module.exports = __toCommonJS(uil_server_connection_exports);
var import_react = __toESM(require("react"), 1);
var UilServerConnection = (_a) => {
...
var uil_server_connection_default = UilServerConnection;
