...
// src/icons/uil-tag-alt.tsx
var uil_tag_alt_exports = {};
__export(uil_tag_alt_exports, {
  default: () => uil_tag_alt_default
});
module.exports = __toCommonJS(uil_tag_alt_exports);
...
var uil_tag_alt_default = UilTagAlt;
