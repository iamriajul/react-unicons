...
// src/icons/uil-wifi.tsx
var uil_wifi_exports = {};
__export(uil_wifi_exports, {
  default: () => uil_wifi_default
});
module.exports = __toCommonJS(uil_wifi_exports);
