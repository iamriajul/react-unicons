...
// src/icons/uil-watch.tsx
var uil_watch_exports = {};
__export(uil_watch_exports, {
  default: () => uil_watch_default
});
module.exports = __toCommonJS(uil_watch_exports);
...
var uil_watch_default = UilWatch;
