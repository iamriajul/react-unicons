...
// src/icons/uil-bolt.tsx
var uil_bolt_exports = {};
__export(uil_bolt_exports, {
  default: () => uil_bolt_default
});
module.exports = __toCommonJS(uil_bolt_exports);
