...
// src/icons/uil-sliders-v.tsx
var uil_sliders_v_exports = {};
__export(uil_sliders_v_exports, {
  default: () => uil_sliders_v_default
});
module.exports = __toCommonJS(uil_sliders_v_exports);
...
var uil_sliders_v_default = UilSlidersV;
