...
// src/icons/uil-feedback.tsx
var uil_feedback_exports = {};
__export(uil_feedback_exports, {
  default: () => uil_feedback_default
});
module.exports = __toCommonJS(uil_feedback_exports);
...
var uil_feedback_default = UilFeedback;
