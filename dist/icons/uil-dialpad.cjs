...
// src/icons/uil-dialpad.tsx
var uil_dialpad_exports = {};
__export(uil_dialpad_exports, {
  default: () => uil_dialpad_default
});
module.exports = __toCommonJS(uil_dialpad_exports);
...
var uil_dialpad_default = UilDialpad;
