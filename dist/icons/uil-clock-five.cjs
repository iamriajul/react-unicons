...
// src/icons/uil-clock-five.tsx
var uil_clock_five_exports = {};
__export(uil_clock_five_exports, {
  default: () => uil_clock_five_default
});
module.exports = __toCommonJS(uil_clock_five_exports);
...
var uil_clock_five_default = UilClockFive;
