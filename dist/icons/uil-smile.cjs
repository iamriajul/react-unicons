...
// src/icons/uil-smile.tsx
var uil_smile_exports = {};
__export(uil_smile_exports, {
  default: () => uil_smile_default
});
module.exports = __toCommonJS(uil_smile_exports);
...
var uil_smile_default = UilSmile;
