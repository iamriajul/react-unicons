...
var uil_folder_exclamation_exports = {};
__export(uil_folder_exclamation_exports, {
  default: () => uil_folder_exclamation_default
});
module.exports = __toCommonJS(uil_folder_exclamation_exports);
