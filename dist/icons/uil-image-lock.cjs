...
// src/icons/uil-image-lock.tsx
var uil_image_lock_exports = {};
__export(uil_image_lock_exports, {
  default: () => uil_image_lock_default
});
module.exports = __toCommonJS(uil_image_lock_exports);
...
var uil_image_lock_default = UilImageLock;
