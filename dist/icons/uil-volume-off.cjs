...
// src/icons/uil-volume-off.tsx
var uil_volume_off_exports = {};
__export(uil_volume_off_exports, {
  default: () => uil_volume_off_default
});
module.exports = __toCommonJS(uil_volume_off_exports);
...
var uil_volume_off_default = UilVolumeOff;
