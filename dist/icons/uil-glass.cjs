...
// src/icons/uil-glass.tsx
var uil_glass_exports = {};
__export(uil_glass_exports, {
  default: () => uil_glass_default
});
module.exports = __toCommonJS(uil_glass_exports);
...
var uil_glass_default = UilGlass;
