...
// src/icons/uil-import.tsx
var uil_import_exports = {};
__export(uil_import_exports, {
  default: () => uil_import_default
});
module.exports = __toCommonJS(uil_import_exports);
...
var uil_import_default = UilImport;
