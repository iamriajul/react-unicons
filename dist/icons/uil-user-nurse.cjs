...
// src/icons/uil-user-nurse.tsx
var uil_user_nurse_exports = {};
__export(uil_user_nurse_exports, {
  default: () => uil_user_nurse_default
});
module.exports = __toCommonJS(uil_user_nurse_exports);
...
var uil_user_nurse_default = UilUserNurse;
