...
// src/icons/uil-unlock.tsx
var uil_unlock_exports = {};
__export(uil_unlock_exports, {
  default: () => uil_unlock_default
});
module.exports = __toCommonJS(uil_unlock_exports);
...
var uil_unlock_default = UilUnlock;
