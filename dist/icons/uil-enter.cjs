...
// src/icons/uil-enter.tsx
var uil_enter_exports = {};
__export(uil_enter_exports, {
  default: () => uil_enter_default
});
module.exports = __toCommonJS(uil_enter_exports);
...
var uil_enter_default = UilEnter;
