...
var uil_sync_exclamation_exports = {};
__export(uil_sync_exclamation_exports, {
  default: () => uil_sync_exclamation_default
});
module.exports = __toCommonJS(uil_sync_exclamation_exports);
