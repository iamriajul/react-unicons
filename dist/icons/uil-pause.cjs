...
// src/icons/uil-pause.tsx
var uil_pause_exports = {};
__export(uil_pause_exports, {
  default: () => uil_pause_default
});
module.exports = __toCommonJS(uil_pause_exports);
...
var uil_pause_default = UilPause;
