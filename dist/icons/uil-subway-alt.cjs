...
// src/icons/uil-subway-alt.tsx
var uil_subway_alt_exports = {};
__export(uil_subway_alt_exports, {
  default: () => uil_subway_alt_default
});
module.exports = __toCommonJS(uil_subway_alt_exports);
...
var uil_subway_alt_default = UilSubwayAlt;
