...
// src/icons/uil-usd-square.tsx
var uil_usd_square_exports = {};
__export(uil_usd_square_exports, {
  default: () => uil_usd_square_default
});
module.exports = __toCommonJS(uil_usd_square_exports);
...
var uil_usd_square_default = UilUsdSquare;
