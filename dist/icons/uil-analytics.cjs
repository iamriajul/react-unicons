...
// src/icons/uil-analytics.tsx
var uil_analytics_exports = {};
__export(uil_analytics_exports, {
  default: () => uil_analytics_default
});
module.exports = __toCommonJS(uil_analytics_exports);
...
var uil_analytics_default = UilAnalytics;
