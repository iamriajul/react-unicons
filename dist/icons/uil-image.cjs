...
// src/icons/uil-image.tsx
var uil_image_exports = {};
__export(uil_image_exports, {
  default: () => uil_image_default
});
module.exports = __toCommonJS(uil_image_exports);
...
var uil_image_default = UilImage;
