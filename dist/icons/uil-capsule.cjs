...
// src/icons/uil-capsule.tsx
var uil_capsule_exports = {};
__export(uil_capsule_exports, {
  default: () => uil_capsule_default
});
module.exports = __toCommonJS(uil_capsule_exports);
...
var uil_capsule_default = UilCapsule;
