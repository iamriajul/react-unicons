...
// src/icons/uil-auto-flash.tsx
var uil_auto_flash_exports = {};
__export(uil_auto_flash_exports, {
  default: () => uil_auto_flash_default
});
module.exports = __toCommonJS(uil_auto_flash_exports);
...
var uil_auto_flash_default = UilAutoFlash;
