...
// src/icons/uil-sad-dizzy.tsx
var uil_sad_dizzy_exports = {};
__export(uil_sad_dizzy_exports, {
  default: () => uil_sad_dizzy_default
});
module.exports = __toCommonJS(uil_sad_dizzy_exports);
...
var uil_sad_dizzy_default = UilSadDizzy;
