...
// src/icons/uil-gold.tsx
var uil_gold_exports = {};
__export(uil_gold_exports, {
  default: () => uil_gold_default
});
module.exports = __toCommonJS(uil_gold_exports);
