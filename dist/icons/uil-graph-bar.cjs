...
// src/icons/uil-graph-bar.tsx
var uil_graph_bar_exports = {};
__export(uil_graph_bar_exports, {
  default: () => uil_graph_bar_default
});
module.exports = __toCommonJS(uil_graph_bar_exports);
...
var uil_graph_bar_default = UilGraphBar;
