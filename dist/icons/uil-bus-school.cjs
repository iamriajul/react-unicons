...
// src/icons/uil-bus-school.tsx
var uil_bus_school_exports = {};
__export(uil_bus_school_exports, {
  default: () => uil_bus_school_default
});
module.exports = __toCommonJS(uil_bus_school_exports);
...
var uil_bus_school_default = UilBusSchool;
