...
// src/icons/uil-chart-pie.tsx
var uil_chart_pie_exports = {};
__export(uil_chart_pie_exports, {
  default: () => uil_chart_pie_default
});
module.exports = __toCommonJS(uil_chart_pie_exports);
...
var uil_chart_pie_default = UilChartPie;
