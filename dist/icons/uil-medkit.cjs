...
// src/icons/uil-medkit.tsx
var uil_medkit_exports = {};
__export(uil_medkit_exports, {
  default: () => uil_medkit_default
});
module.exports = __toCommonJS(uil_medkit_exports);
...
var uil_medkit_default = UilMedkit;
