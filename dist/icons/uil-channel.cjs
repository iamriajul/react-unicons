...
// src/icons/uil-channel.tsx
var uil_channel_exports = {};
__export(uil_channel_exports, {
  default: () => uil_channel_default
});
module.exports = __toCommonJS(uil_channel_exports);
...
var uil_channel_default = UilChannel;
