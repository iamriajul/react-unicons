...
// src/icons/uil-sign-left.tsx
var uil_sign_left_exports = {};
__export(uil_sign_left_exports, {
  default: () => uil_sign_left_default
});
module.exports = __toCommonJS(uil_sign_left_exports);
...
var uil_sign_left_default = UilSignLeft;
