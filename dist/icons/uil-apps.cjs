...
// src/icons/uil-apps.tsx
var uil_apps_exports = {};
__export(uil_apps_exports, {
  default: () => uil_apps_default
});
module.exports = __toCommonJS(uil_apps_exports);
