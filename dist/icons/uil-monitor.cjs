...
// src/icons/uil-monitor.tsx
var uil_monitor_exports = {};
__export(uil_monitor_exports, {
  default: () => uil_monitor_default
});
module.exports = __toCommonJS(uil_monitor_exports);
...
var uil_monitor_default = UilMonitor;
