...
// src/icons/uil-compress-v.tsx
var uil_compress_v_exports = {};
__export(uil_compress_v_exports, {
  default: () => uil_compress_v_default
});
module.exports = __toCommonJS(uil_compress_v_exports);
...
var uil_compress_v_default = UilCompressV;
