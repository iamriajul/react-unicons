...
// src/icons/uil-0-plus.tsx
var uil_0_plus_exports = {};
__export(uil_0_plus_exports, {
  default: () => uil_0_plus_default
});
module.exports = __toCommonJS(uil_0_plus_exports);
...
var uil_0_plus_default = Uil0Plus;
