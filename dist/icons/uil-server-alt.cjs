...
// src/icons/uil-server-alt.tsx
var uil_server_alt_exports = {};
__export(uil_server_alt_exports, {
  default: () => uil_server_alt_default
});
module.exports = __toCommonJS(uil_server_alt_exports);
...
var uil_server_alt_default = UilServerAlt;
