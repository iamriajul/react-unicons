...
// src/icons/uil-dice-five.tsx
var uil_dice_five_exports = {};
__export(uil_dice_five_exports, {
  default: () => uil_dice_five_default
});
module.exports = __toCommonJS(uil_dice_five_exports);
...
var uil_dice_five_default = UilDiceFive;
