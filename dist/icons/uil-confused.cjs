...
// src/icons/uil-confused.tsx
var uil_confused_exports = {};
__export(uil_confused_exports, {
  default: () => uil_confused_default
});
module.exports = __toCommonJS(uil_confused_exports);
...
var uil_confused_default = UilConfused;
