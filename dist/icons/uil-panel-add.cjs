...
// src/icons/uil-panel-add.tsx
var uil_panel_add_exports = {};
__export(uil_panel_add_exports, {
  default: () => uil_panel_add_default
});
module.exports = __toCommonJS(uil_panel_add_exports);
...
var uil_panel_add_default = UilPanelAdd;
