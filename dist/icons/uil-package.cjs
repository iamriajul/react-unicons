...
// src/icons/uil-package.tsx
var uil_package_exports = {};
__export(uil_package_exports, {
  default: () => uil_package_default
});
module.exports = __toCommonJS(uil_package_exports);
...
var uil_package_default = UilPackage;
