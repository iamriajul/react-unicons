...
// src/icons/uil-docker.tsx
var uil_docker_exports = {};
__export(uil_docker_exports, {
  default: () => uil_docker_default
});
module.exports = __toCommonJS(uil_docker_exports);
...
var uil_docker_default = UilDocker;
