...
// src/icons/uil-bell-slash.tsx
var uil_bell_slash_exports = {};
__export(uil_bell_slash_exports, {
  default: () => uil_bell_slash_default
});
module.exports = __toCommonJS(uil_bell_slash_exports);
...
var uil_bell_slash_default = UilBellSlash;
