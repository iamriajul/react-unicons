...
// src/icons/uil-tape.tsx
var uil_tape_exports = {};
__export(uil_tape_exports, {
  default: () => uil_tape_default
});
module.exports = __toCommonJS(uil_tape_exports);
