...
// src/icons/uil-silence.tsx
var uil_silence_exports = {};
__export(uil_silence_exports, {
  default: () => uil_silence_default
});
module.exports = __toCommonJS(uil_silence_exports);
...
var uil_silence_default = UilSilence;
