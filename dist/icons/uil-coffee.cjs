...
// src/icons/uil-coffee.tsx
var uil_coffee_exports = {};
__export(uil_coffee_exports, {
  default: () => uil_coffee_default
});
module.exports = __toCommonJS(uil_coffee_exports);
...
var uil_coffee_default = UilCoffee;
