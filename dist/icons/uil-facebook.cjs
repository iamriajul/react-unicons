...
// src/icons/uil-facebook.tsx
var uil_facebook_exports = {};
__export(uil_facebook_exports, {
  default: () => uil_facebook_default
});
module.exports = __toCommonJS(uil_facebook_exports);
...
var uil_facebook_default = UilFacebook;
