...
// src/icons/uil-rss-alt.tsx
var uil_rss_alt_exports = {};
__export(uil_rss_alt_exports, {
  default: () => uil_rss_alt_default
});
module.exports = __toCommonJS(uil_rss_alt_exports);
...
var uil_rss_alt_default = UilRssAlt;
