...
// src/icons/uil-sad-squint.tsx
var uil_sad_squint_exports = {};
__export(uil_sad_squint_exports, {
  default: () => uil_sad_squint_default
});
module.exports = __toCommonJS(uil_sad_squint_exports);
...
var uil_sad_squint_default = UilSadSquint;
