...
// src/icons/uil-clock-ten.tsx
var uil_clock_ten_exports = {};
__export(uil_clock_ten_exports, {
  default: () => uil_clock_ten_default
});
module.exports = __toCommonJS(uil_clock_ten_exports);
...
var uil_clock_ten_default = UilClockTen;
