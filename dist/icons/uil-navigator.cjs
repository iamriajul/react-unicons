...
// src/icons/uil-navigator.tsx
var uil_navigator_exports = {};
__export(uil_navigator_exports, {
  default: () => uil_navigator_default
});
module.exports = __toCommonJS(uil_navigator_exports);
...
var uil_navigator_default = UilNavigator;
