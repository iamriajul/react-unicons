...
// src/icons/uil-backspace.tsx
var uil_backspace_exports = {};
__export(uil_backspace_exports, {
  default: () => uil_backspace_default
});
module.exports = __toCommonJS(uil_backspace_exports);
...
var uil_backspace_default = UilBackspace;
