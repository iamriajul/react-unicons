...
// src/icons/uil-minus-path.tsx
var uil_minus_path_exports = {};
__export(uil_minus_path_exports, {
  default: () => uil_minus_path_default
});
module.exports = __toCommonJS(uil_minus_path_exports);
...
var uil_minus_path_default = UilMinusPath;
