...
// src/icons/uil-server.tsx
var uil_server_exports = {};
__export(uil_server_exports, {
  default: () => uil_server_default
});
module.exports = __toCommonJS(uil_server_exports);
...
var uil_server_default = UilServer;
