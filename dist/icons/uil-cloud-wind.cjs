...
// src/icons/uil-cloud-wind.tsx
var uil_cloud_wind_exports = {};
__export(uil_cloud_wind_exports, {
  default: () => uil_cloud_wind_default
});
module.exports = __toCommonJS(uil_cloud_wind_exports);
...
var uil_cloud_wind_default = UilCloudWind;
