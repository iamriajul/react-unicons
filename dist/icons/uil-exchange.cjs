...
// src/icons/uil-exchange.tsx
var uil_exchange_exports = {};
__export(uil_exchange_exports, {
  default: () => uil_exchange_default
});
module.exports = __toCommonJS(uil_exchange_exports);
...
var uil_exchange_default = UilExchange;
