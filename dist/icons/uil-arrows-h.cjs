...
// src/icons/uil-arrows-h.tsx
var uil_arrows_h_exports = {};
__export(uil_arrows_h_exports, {
  default: () => uil_arrows_h_default
});
module.exports = __toCommonJS(uil_arrows_h_exports);
...
var uil_arrows_h_default = UilArrowsH;
