...
// src/icons/uil-image-edit.tsx
var uil_image_edit_exports = {};
__export(uil_image_edit_exports, {
  default: () => uil_image_edit_default
});
module.exports = __toCommonJS(uil_image_edit_exports);
...
var uil_image_edit_default = UilImageEdit;
