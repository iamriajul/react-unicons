...
// src/icons/uil-cloud-lock.tsx
var uil_cloud_lock_exports = {};
__export(uil_cloud_lock_exports, {
  default: () => uil_cloud_lock_default
});
module.exports = __toCommonJS(uil_cloud_lock_exports);
...
var uil_cloud_lock_default = UilCloudLock;
