...
// src/icons/uil-wifi-slash.tsx
var uil_wifi_slash_exports = {};
__export(uil_wifi_slash_exports, {
  default: () => uil_wifi_slash_default
});
module.exports = __toCommonJS(uil_wifi_slash_exports);
...
var uil_wifi_slash_default = UilWifiSlash;
