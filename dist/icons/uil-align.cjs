...
// src/icons/uil-align.tsx
var uil_align_exports = {};
__export(uil_align_exports, {
  default: () => uil_align_default
});
module.exports = __toCommonJS(uil_align_exports);
...
var uil_align_default = UilAlign;
