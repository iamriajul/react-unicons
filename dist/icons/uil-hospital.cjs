...
// src/icons/uil-hospital.tsx
var uil_hospital_exports = {};
__export(uil_hospital_exports, {
  default: () => uil_hospital_default
});
module.exports = __toCommonJS(uil_hospital_exports);
...
var uil_hospital_default = UilHospital;
