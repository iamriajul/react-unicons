...
// src/icons/uil-comments.tsx
var uil_comments_exports = {};
__export(uil_comments_exports, {
  default: () => uil_comments_default
});
module.exports = __toCommonJS(uil_comments_exports);
...
var uil_comments_default = UilComments;
