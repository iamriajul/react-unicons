...
// src/icons/uil-tumblr.tsx
var uil_tumblr_exports = {};
__export(uil_tumblr_exports, {
  default: () => uil_tumblr_default
});
module.exports = __toCommonJS(uil_tumblr_exports);
...
var uil_tumblr_default = UilTumblr;
