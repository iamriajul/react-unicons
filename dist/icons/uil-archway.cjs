...
// src/icons/uil-archway.tsx
var uil_archway_exports = {};
__export(uil_archway_exports, {
  default: () => uil_archway_default
});
module.exports = __toCommonJS(uil_archway_exports);
...
var uil_archway_default = UilArchway;
