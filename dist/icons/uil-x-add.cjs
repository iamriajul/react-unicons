...
// src/icons/uil-x-add.tsx
var uil_x_add_exports = {};
__export(uil_x_add_exports, {
  default: () => uil_x_add_default
});
module.exports = __toCommonJS(uil_x_add_exports);
