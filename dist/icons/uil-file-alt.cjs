...
// src/icons/uil-file-alt.tsx
var uil_file_alt_exports = {};
__export(uil_file_alt_exports, {
  default: () => uil_file_alt_default
});
module.exports = __toCommonJS(uil_file_alt_exports);
...
var uil_file_alt_default = UilFileAlt;
