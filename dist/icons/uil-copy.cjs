...
// src/icons/uil-copy.tsx
var uil_copy_exports = {};
__export(uil_copy_exports, {
  default: () => uil_copy_default
});
module.exports = __toCommonJS(uil_copy_exports);
