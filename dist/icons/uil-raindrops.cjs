...
// src/icons/uil-raindrops.tsx
var uil_raindrops_exports = {};
__export(uil_raindrops_exports, {
  default: () => uil_raindrops_default
});
module.exports = __toCommonJS(uil_raindrops_exports);
...
var uil_raindrops_default = UilRaindrops;
