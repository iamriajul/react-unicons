...
// src/icons/uil-export.tsx
var uil_export_exports = {};
__export(uil_export_exports, {
  default: () => uil_export_default
});
module.exports = __toCommonJS(uil_export_exports);
...
var uil_export_default = UilExport;
