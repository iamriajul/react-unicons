...
// src/icons/uil-compress.tsx
var uil_compress_exports = {};
__export(uil_compress_exports, {
  default: () => uil_compress_default
});
module.exports = __toCommonJS(uil_compress_exports);
...
var uil_compress_default = UilCompress;
