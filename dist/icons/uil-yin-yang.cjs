...
// src/icons/uil-yin-yang.tsx
var uil_yin_yang_exports = {};
__export(uil_yin_yang_exports, {
  default: () => uil_yin_yang_default
});
module.exports = __toCommonJS(uil_yin_yang_exports);
...
var uil_yin_yang_default = UilYinYang;
