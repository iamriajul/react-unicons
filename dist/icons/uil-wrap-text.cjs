...
// src/icons/uil-wrap-text.tsx
var uil_wrap_text_exports = {};
__export(uil_wrap_text_exports, {
  default: () => uil_wrap_text_default
});
module.exports = __toCommonJS(uil_wrap_text_exports);
...
var uil_wrap_text_default = UilWrapText;
