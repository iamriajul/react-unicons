...
// src/icons/uil-coins.tsx
var uil_coins_exports = {};
__export(uil_coins_exports, {
  default: () => uil_coins_default
});
module.exports = __toCommonJS(uil_coins_exports);
...
var uil_coins_default = UilCoins;
