...
// src/icons/uil-sync.tsx
var uil_sync_exports = {};
__export(uil_sync_exports, {
  default: () => uil_sync_default
});
module.exports = __toCommonJS(uil_sync_exports);
