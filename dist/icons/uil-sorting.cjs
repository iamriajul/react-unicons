...
// src/icons/uil-sorting.tsx
var uil_sorting_exports = {};
__export(uil_sorting_exports, {
  default: () => uil_sorting_default
});
module.exports = __toCommonJS(uil_sorting_exports);
...
var uil_sorting_default = UilSorting;
