...
// src/icons/uil-keyboard.tsx
var uil_keyboard_exports = {};
__export(uil_keyboard_exports, {
  default: () => uil_keyboard_default
});
module.exports = __toCommonJS(uil_keyboard_exports);
...
var uil_keyboard_default = UilKeyboard;
