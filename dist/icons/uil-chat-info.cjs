...
// src/icons/uil-chat-info.tsx
var uil_chat_info_exports = {};
__export(uil_chat_info_exports, {
  default: () => uil_chat_info_default
});
module.exports = __toCommonJS(uil_chat_info_exports);
...
var uil_chat_info_default = UilChatInfo;
