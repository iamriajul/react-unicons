...
// src/icons/uil-compass.tsx
var uil_compass_exports = {};
__export(uil_compass_exports, {
  default: () => uil_compass_default
});
module.exports = __toCommonJS(uil_compass_exports);
...
var uil_compass_default = UilCompass;
