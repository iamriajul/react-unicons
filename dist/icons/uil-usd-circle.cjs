...
// src/icons/uil-usd-circle.tsx
var uil_usd_circle_exports = {};
__export(uil_usd_circle_exports, {
  default: () => uil_usd_circle_default
});
module.exports = __toCommonJS(uil_usd_circle_exports);
...
var uil_usd_circle_default = UilUsdCircle;
