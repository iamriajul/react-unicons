...
// src/icons/uil-sign-in-alt.tsx
var uil_sign_in_alt_exports = {};
__export(uil_sign_in_alt_exports, {
  default: () => uil_sign_in_alt_default
});
module.exports = __toCommonJS(uil_sign_in_alt_exports);
...
var uil_sign_in_alt_default = UilSignInAlt;
