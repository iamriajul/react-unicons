...
// src/icons/uil-abacus.tsx
var uil_abacus_exports = {};
__export(uil_abacus_exports, {
  default: () => uil_abacus_default
});
module.exports = __toCommonJS(uil_abacus_exports);
...
var uil_abacus_default = UilAbacus;
