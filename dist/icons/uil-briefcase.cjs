...
// src/icons/uil-briefcase.tsx
var uil_briefcase_exports = {};
__export(uil_briefcase_exports, {
  default: () => uil_briefcase_default
});
module.exports = __toCommonJS(uil_briefcase_exports);
...
var uil_briefcase_default = UilBriefcase;
