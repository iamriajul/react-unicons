...
// src/icons/uil-angry.tsx
var uil_angry_exports = {};
__export(uil_angry_exports, {
  default: () => uil_angry_default
});
module.exports = __toCommonJS(uil_angry_exports);
...
var uil_angry_default = UilAngry;
