...
// src/icons/uil-panorama-v.tsx
var uil_panorama_v_exports = {};
__export(uil_panorama_v_exports, {
  default: () => uil_panorama_v_default
});
module.exports = __toCommonJS(uil_panorama_v_exports);
...
var uil_panorama_v_default = UilPanoramaV;
