...
// src/icons/uil-film.tsx
var uil_film_exports = {};
__export(uil_film_exports, {
  default: () => uil_film_default
});
module.exports = __toCommonJS(uil_film_exports);
