...
// src/icons/uil-cancel.tsx
var uil_cancel_exports = {};
__export(uil_cancel_exports, {
  default: () => uil_cancel_default
});
module.exports = __toCommonJS(uil_cancel_exports);
...
var uil_cancel_default = UilCancel;
