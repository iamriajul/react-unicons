...
// src/icons/uil-book.tsx
var uil_book_exports = {};
__export(uil_book_exports, {
  default: () => uil_book_default
});
module.exports = __toCommonJS(uil_book_exports);
