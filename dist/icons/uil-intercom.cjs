...
// src/icons/uil-intercom.tsx
var uil_intercom_exports = {};
__export(uil_intercom_exports, {
  default: () => uil_intercom_default
});
module.exports = __toCommonJS(uil_intercom_exports);
...
var uil_intercom_default = UilIntercom;
