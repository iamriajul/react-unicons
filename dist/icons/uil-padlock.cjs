...
// src/icons/uil-padlock.tsx
var uil_padlock_exports = {};
__export(uil_padlock_exports, {
  default: () => uil_padlock_default
});
module.exports = __toCommonJS(uil_padlock_exports);
...
var uil_padlock_default = UilPadlock;
