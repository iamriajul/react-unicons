...
// src/icons/uil-scroll-h.tsx
var uil_scroll_h_exports = {};
__export(uil_scroll_h_exports, {
  default: () => uil_scroll_h_default
});
module.exports = __toCommonJS(uil_scroll_h_exports);
...
var uil_scroll_h_default = UilScrollH;
