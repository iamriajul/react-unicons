...
// src/icons/uil-lock-alt.tsx
var uil_lock_alt_exports = {};
__export(uil_lock_alt_exports, {
  default: () => uil_lock_alt_default
});
module.exports = __toCommonJS(uil_lock_alt_exports);
...
var uil_lock_alt_default = UilLockAlt;
