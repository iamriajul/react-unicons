...
// src/icons/uil-dizzy-meh.tsx
var uil_dizzy_meh_exports = {};
__export(uil_dizzy_meh_exports, {
  default: () => uil_dizzy_meh_default
});
module.exports = __toCommonJS(uil_dizzy_meh_exports);
...
var uil_dizzy_meh_default = UilDizzyMeh;
