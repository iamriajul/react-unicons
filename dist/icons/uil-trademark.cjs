...
// src/icons/uil-trademark.tsx
var uil_trademark_exports = {};
__export(uil_trademark_exports, {
  default: () => uil_trademark_default
});
module.exports = __toCommonJS(uil_trademark_exports);
...
var uil_trademark_default = UilTrademark;
