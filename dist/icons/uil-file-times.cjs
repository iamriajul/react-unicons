...
// src/icons/uil-file-times.tsx
var uil_file_times_exports = {};
__export(uil_file_times_exports, {
  default: () => uil_file_times_default
});
module.exports = __toCommonJS(uil_file_times_exports);
...
var uil_file_times_default = UilFileTimes;
