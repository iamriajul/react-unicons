...
// src/icons/uil-volume-up.tsx
var uil_volume_up_exports = {};
__export(uil_volume_up_exports, {
  default: () => uil_volume_up_default
});
module.exports = __toCommonJS(uil_volume_up_exports);
...
var uil_volume_up_default = UilVolumeUp;
