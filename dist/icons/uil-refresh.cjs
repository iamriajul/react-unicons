...
// src/icons/uil-refresh.tsx
var uil_refresh_exports = {};
__export(uil_refresh_exports, {
  default: () => uil_refresh_default
});
module.exports = __toCommonJS(uil_refresh_exports);
...
var uil_refresh_default = UilRefresh;
