...
// src/icons/uil-processor.tsx
var uil_processor_exports = {};
__export(uil_processor_exports, {
  default: () => uil_processor_default
});
module.exports = __toCommonJS(uil_processor_exports);
...
var uil_processor_default = UilProcessor;
