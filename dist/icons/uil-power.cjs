...
// src/icons/uil-power.tsx
var uil_power_exports = {};
__export(uil_power_exports, {
  default: () => uil_power_default
});
module.exports = __toCommonJS(uil_power_exports);
...
var uil_power_default = UilPower;
