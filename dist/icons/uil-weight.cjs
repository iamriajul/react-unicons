...
// src/icons/uil-weight.tsx
var uil_weight_exports = {};
__export(uil_weight_exports, {
  default: () => uil_weight_default
});
module.exports = __toCommonJS(uil_weight_exports);
...
var uil_weight_default = UilWeight;
