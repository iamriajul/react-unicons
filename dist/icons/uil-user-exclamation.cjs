...
var uil_user_exclamation_exports = {};
__export(uil_user_exclamation_exports, {
  default: () => uil_user_exclamation_default
});
module.exports = __toCommonJS(uil_user_exclamation_exports);
