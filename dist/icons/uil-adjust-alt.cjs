...
// src/icons/uil-adjust-alt.tsx
var uil_adjust_alt_exports = {};
__export(uil_adjust_alt_exports, {
  default: () => uil_adjust_alt_default
});
module.exports = __toCommonJS(uil_adjust_alt_exports);
...
var uil_adjust_alt_default = UilAdjustAlt;
