...
// src/icons/uil-suitcase.tsx
var uil_suitcase_exports = {};
__export(uil_suitcase_exports, {
  default: () => uil_suitcase_default
});
module.exports = __toCommonJS(uil_suitcase_exports);
...
var uil_suitcase_default = UilSuitcase;
