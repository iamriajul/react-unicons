...
// src/icons/uil-user-minus.tsx
var uil_user_minus_exports = {};
__export(uil_user_minus_exports, {
  default: () => uil_user_minus_default
});
module.exports = __toCommonJS(uil_user_minus_exports);
...
var uil_user_minus_default = UilUserMinus;
